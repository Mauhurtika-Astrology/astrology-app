              ...
              children: [
                TextButton(
                  ...
                  style: ButtonStyle(
                    ...
                    backgroundColor: WidgetStateProperty.all(kundliController.isNorthIn ? Get.theme.primaryColor : Colors.grey),
                ...
                TextButton(
                  ...
                  style: ButtonStyle(
                    padding: WidgetStateProperty.all(const EdgeInsets.all(6)),
                    backgroundColor: WidgetStateProperty.all(kundliController.isSouthIn ? Get.theme.primaryColor : Colors.grey),
                    shape: WidgetStateProperty.all(
                      RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(5),
                      ),
